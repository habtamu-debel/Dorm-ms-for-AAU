  ...
  <div class="container">
    ...
    <div class="proctor-info-container">
        <div class="button-list">
          ...
          <div class="dropdown">
  <a href="{{ route('registrarAnnouncement.create') }}"class="btnPrimary">Post Announcment</a>
  <div class="dropdown-content">
    <a href="{{ route('registrarAnnouncement.index') }}">All Announcments</a>
    <!-- Add more menu items if needed -->
  </div>
</div> 
         
          <a href="{{ route('directorReport.indexx') }}" class="btnPrimary">Show Report</a> 
        
          <a href="{{ route('showStudents') }}"  class="btnPrimary">Send Student List</a>
    ...
    <h5>Registrar Director Information</h5>
