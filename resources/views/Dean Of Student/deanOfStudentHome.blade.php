  ...
  <div class="container">
    ...
    <div class="proctor-info-container">
        <div class="button-list">
          ...
          <a href="{{ route('directorAnnouncement.indexx') }}" class="btn btn-primary">View Announcment</a>         
          <div class="dropdown">
  <a href="{{ route('deanAnnouncement.create') }}" class="btnPrimary">Post Announcment</a>
  <div class="dropdown-content">
    <a href="{{ route('deanAnnouncementtt.views')}}">All Announcments</a>
    <!-- Add more menu items if needed -->
  </div>
</div> 
         
          <a href="{{ route('deanReport.create') }}" class="btnPrimary">Generate Report</a> 
          
          <a href="{{ route('Dean Of Student.feedback') }}" class="btnPrimary">Give Feedbacks</a> 
          <a href="{{ route('pmreports.indexx') }}" class="btnPrimary">Show Reports</a>
          <a href="{{ route('appointment.view') }}" class="btnPrimary">View Appointments</a>
          <a href="#" class="btnPrimary">Send Student List</a>
          
        </div>

          
            <div class="proctor-profile">
    <h3>Dean of Students Information</h3>
