  ...
  <div class="container">
    ...
    <div class="proctor-info-container">
        <div class="button-list">
          ...
          <a href="{{ route('registrarAnnouncement.indexx') }}" class="btn btn-primary">View Announcment</a>         
          <div class="dropdown">
  <a href="{{ route('directorAnnouncement.create') }}" class="btnPrimary">Post Announcment</a>
  <div class="dropdown-content">
  <a href="{{ route('directorAnnouncement.index') }}">All Announcements</a>
    <!-- Add more menu items if needed -->
  </div>
</div> 
         
          <a href="{{ route('directorReport.create') }}" class="btnPrimary">Generate Report</a> 
          
          <a href="{{ route('feedback.dean') }}" class="btnPrimary">Show  Feedbacks</a> 
          <a href="{{ route('deanReport.indexx') }}" class="btnPrimary">Show Reports</a>
          <a href="{{ route('viewStudents') }}" class="btnPrimary">Send Student List</a>
          
        </div>

          
            <div class="proctor-profile">
    <h5>Proctor Director Information</h5>
